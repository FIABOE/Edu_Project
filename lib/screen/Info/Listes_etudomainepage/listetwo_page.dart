...
class ListetwoPage extends StatefulWidget {
  const ListetwoPage({Key? key}) : super(key: key);

  @override
  _ListetwoPageState createState() => _ListetwoPageState();
}

class _ListetwoPageState extends State<ListetwoPage>{
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Choississez une ou plusieurs spécialités \nune ou plusieurs spécialité(s).\nPlusieurs choix possibles',
