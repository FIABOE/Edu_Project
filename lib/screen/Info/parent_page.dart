        ...
        children: [
          ...
          const Center(
            child: Align(
              ...
              child: Text(
                'En quelle(s) classe(s) sont vos \nenfants? vous avez le droit de choisir\n jusqu\'à 4 classes',
                    ...
                    onTap: () {
                      setState(() {
                        if (isSelected) {
                          ...
                          if (selectedDomaineIndexes.length < 4) {
                            ...
                            showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  ...
                                  content: const Text(
                                    'Vous ne pouvez pas sélectionner plus de quatre options.',
                                      style: TextStyle(
                                        fontSize: 18,
